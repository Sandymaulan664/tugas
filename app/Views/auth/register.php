                        ...
                        <div class="col-lg">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-green-800 mb-4"><?= lang('Auth.register') ?></h1>
                                </div>
                                ...
                                <hr>
                                <div class="text-center ">
                                    <a class="small text-success" <?=lang('Auth.alreadyRegistered')?> href="<?= url_to('login') ?>">Already have an account? <?=lang('Auth.signIn')?></a>
                                </div>
                            </div>
                        </div>
                    </div>
